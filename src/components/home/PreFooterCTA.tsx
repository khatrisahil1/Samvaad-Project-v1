...
export const PreFooterCTA: React.FC<Props> = ({ onOpenModal }) => {
    return (
      <section
        id="contact"
        className="relative bg-[#262727] py-28 md:py-36 overflow-hidden"
      >
        <div className="absolute -top-40 -left-40 w-[500px] h-[500px] bg-[#74391e] opacity-30 rounded-full filter blur-3xl"></div>
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6">
          <div className="rounded-2xl border border-white/10 bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl shadow-2xl p-10 md:p-16 text-center">
            ...
            <p className="text-white/80 font-body text-lg md:text-xl mb-8 max-w-2xl mx-auto">
              Collaborate with us to bring impactful ideas to life.
            </p>
            <button
              onClick={onOpenModal}
              className="inline-flex items-center gap-3 bg-white text-[#262727] px-8 py-3 rounded-full font-semibold text-lg shadow-md hover:bg-[#f5f5f4] transition-all duration-300 hover:scale-105 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2"
            >
